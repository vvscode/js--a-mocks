(function() {
  ...
  function addUnmockedRequest(reqPart) {
    ...
    (typeof window._ajaxCache.onNotMockNotFound === 'function') && window._ajaxCache.onNotMockNotFound(notFoundedMockItem);
  }
  ...
  function mockAjax() {
    $.mockjax(function(requestSettings) {
      ...
      if (window._ajaxCache.collectMocks) {
        ...
        requestSettings._origSettings.success = function(response, textStatus, jqXHR) {
    ...
    window._ajaxCache = {
      ...
      removeMockItemOnUse: !!document.cookie.match('ajaxMocks_removeMockItemOnUse'),
